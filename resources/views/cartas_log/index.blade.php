...
<head>
  <meta charset="UTF-8">
  <title>Control y Seguimiento Cartas SO-LOG</title>
  ...
  <div class="content-header py-3 border-bottom" style="background-color: #f9fafb;">
    <div class="container-fluid d-flex justify-content-between align-items-center">
      <h1 class="m-0 font-weight-bold heading-font" style="color: #333; font-size: 1.5rem;">
        📋 CONTROL Y SEGUIMIENTO DE CARTAS - LOGÍSTICA ALMACENES LOTE IX
      </h1>
  ...
  <div class="container-fluid">
    <div class="card shadow-sm border-0">
      ...
      <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <form method="GET" action="{{ route('cartas_log.index') }}" class="form-inline">
          ...
          <tbody>
            @forelse ($cartas as $index => $carta)
              <tr>
                ...
                <form action="{{ route('cartas_log.update_estado', $carta->id) }}" method="POST">
                  @csrf
                  @method('PATCH')
                ...
                <td class="text-center">
                  ...
                  <button type="button" class="btn btn-sm btn-secondary btn-historial"
                          ...
                          data-url="{{ route('cartas_log.historial', $carta->id) }}"
                          title="Historial de cambios">
                    <i class="fas fa-history"></i>
                  </button>

                  <!-- Eliminar -->
                  <form action="{{ route('cartas_log.destroy', $carta->id) }}" method="POST" class="d-inline-block"
            ...
            <div class="modal fade" id="modalEditar{{ $carta->id }}" tabindex="-1" aria-hidden="true" data-bs-dismiss="modal">
              <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                  ...
                  <form action="{{ route('cartas_log.update', $carta->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
      ...
      <!-- Modal Ver Detalle -->
            <div class="modal fade" id="modalVer{{ $carta->id }}" tabindex="-1" role="dialog">
                    ...
                    <div class="card shadow-sm border-0 mt-3">
                      <div class="card-body">
                            ...
                            <div class="col-md-4 mb-2">
                              <div class="border rounded p-2 h-100">
                                ...
                                @if($carta->{"archivo_{$campo}"})
                                  ...
                                  <a href="{{ route('cartas_log.documentos.preview', [$carta->id, $campo]) }}" target="_blank" class="btn btn-sm btn-outline-primary">
                        ...
                        @if(Auth::user()->tieneAccesoCompleto() && $carta->archivo_carta && !$carta->firmado_verificado)
                          <form action="{{ route('cartas_log.update_verificacion', $carta->id) }}" method="POST" class="mt-2"
              ...
              <div class="modal-footer bg-light d-flex justify-content-between align-items-center">
                ...
                <div>
                  <a href="{{ route('cartas_log.export.pdf.individual', $carta->id) }}"
    ...
    <div class="modal-content shadow-lg" style="border-radius:16px;">
      ...
      <div class="modal-header text-white"
        ...
        <h5 class="modal-title font-weight-bold" id="modalAgregarLabel">
          <i class="fas fa-file-alt mr-2"></i> Registro de Carta SO-LOG
        </h5>
      ...
      <form action="{{ route('cartas_log.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
              ...
              <div class="form-row">
                <div class="form-group col-md-4">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="codigo" required placeholder="Ej: UNIE-SO-LOG-L-IX-001-2026">
                  </div>
                </div>
...
<a href="{{ route('cartas_log.export.excel', ['buscar' => $buscar]) }}"
...
<script>
    ...
    document.addEventListener('shown.bs.modal', function (e) {
        ...
        fetch('{{ route("cartas_log.documentos.carpetas") }}', { headers: { 'Accept': 'application/json' } })
