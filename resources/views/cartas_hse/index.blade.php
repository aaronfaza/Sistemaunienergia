            ...
            <div class="modal fade" id="modalEditar{{ $carta->id }}" tabindex="-1" aria-hidden="true" data-bs-dismiss="modal">
              <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                  ...
                  <form action="{{ route('cartas_hse.update', $carta->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="card shadow-sm border-0 mt-3">
                      <div class="card-body">
                            ...
                            <div class="col-md-4 mb-2">
                              <div class="border rounded p-2 h-100">
                                ...
                                @if($carta->{"archivo_{$campo}"})
                                  ...
                                  <a href="{{ route('cartas_hse.documentos.preview', [$carta->id, $campo]) }}" target="_blank" class="btn btn-sm btn-outline-primary">
                        ...
                        @if(Auth::user()->tieneAccesoCompleto() && $carta->archivo_carta && !$carta->firmado_verificado)
                          <form action="{{ route('cartas_hse.update_verificacion', $carta->id) }}" method="POST" class="mt-2"
...
<div class="modal fade" id="modalAgregar" tabindex="-1" role="dialog" aria-labelledby="modalAgregarLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
    <div class="modal-content shadow-lg" style="border-radius:16px;">
      ...
      <form action="{{ route('cartas_hse.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
...
<script>
    ...
    document.addEventListener('shown.bs.modal', function (e) {
        ...
        fetch('{{ route("cartas_hse.documentos.carpetas") }}', { headers: { 'Accept': 'application/json' } })
