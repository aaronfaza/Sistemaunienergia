...
class LogisticaExport implements FromCollection, WithHeadings, WithStyles, WithColumnWidths, WithCustomStartCell, WithEvents
{
    ...
    {
        return [
            'COD. LOG', 'CARPETA', 'ESTADO', 'RESPONSABLE (FIRMA PEND.)', 'N° CARTA', 'ASUNTO',
    ...
    public function styles(Worksheet $sheet)
    {
        return [
            ...
            // Bordes generales (hasta AA, que es Observación)
            'A6:AA1000' => [
                'borders' => [
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                // 1. Barra Verde Neón (se extiende hasta AA)
                ...
                // Formato numérico (columna Q - Monto IGV y W - Monto Factura)
