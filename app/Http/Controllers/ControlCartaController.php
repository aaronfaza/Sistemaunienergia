...
class ControlCartaController extends Controller
{
    ...
    return view('control_cartas.index', compact('cartas', 'buscar', 'anio'));
    }
    ...
    public function store(Request $request, RopDocumentoService $rop)
    {
        ...
        try {
            $data = array_merge($data, $rop->guardarDocumentos(new ControlCarta(), $documentos['archivos'], $documentos['carpeta']));
    ...
    public function exportPdfIndividual($id)
        ...
        /**
         * Carpetas ROP disponibles para el selector del modal de subida
         * (listado en vivo del disco de red, con fallback a los ROP ya
         * registrados en BD).
         */
        ...
        /**
         * Sirve un documento (carta/cotizacion/requerimiento) para
         * previsualizar en el navegador y verificar visualmente que está
         * firmado.
         */
        ...
        /**
         * Marca la carta como firmada y verificada. Solo Admin, y solo
         * después de confirmar (en la previsualización) que el documento
         * realmente está firmado.
         */
