...
return new class extends Migration
{
    ...
    {
        Schema::create('cartas_ipf', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('area')->default('SO-IPF');
            $table->enum('estado', ['Pendiente', 'Rechazado', 'Ejecutado'])->default('Pendiente');
    ...
    {
        Schema::dropIfExists('cartas_ipf');
    }
};
